...
import { getTranslatedMenuField } from "./menu.translations";
                ...
                <ul className={styles.list}>
                  {groupedDrinks.ohneAlkohol.map((it) => {
                    const translatedName =
                      getTranslatedMenuField(it.slug, locale, "name", it.name) ?? it.name;
                    const translatedDescription =
                      getTranslatedMenuField(it.slug, locale, "description", it.description) ??
                      it.description;
                      ...
                      <li key={it.id} className={styles.item}>
                        <div className={styles.left}>
                          <div className={styles.itemHead}>
                            <div className={styles.name}>{translatedName}</div>
                            <div className={styles.price}>{formatPrice(it.price)}</div>
                          </div>
                          {translatedDescription ? (
                            <div className={styles.desc}>{translatedDescription}</div>
                          ) : null}
                        </div>
                      </li>
                    );
