    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.flags} aria-label="Language switcher">
          <a href="/set-locale?l=de&to=/" aria-label="Deutsch" title="Deutsch">🇩🇪</a>
          <a href="/set-locale?l=es&to=/" aria-label="Español" title="Español">🇪🇸</a>
          <a href="/set-locale?l=en&to=/" aria-label="English" title="English">🇬🇧</a>
        </div>
      </section>
